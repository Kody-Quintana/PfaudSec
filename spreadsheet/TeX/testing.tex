...
\newcolumntype{m}{>{\hsize=\hsize}X}%TODO do this in python
\newcolumntype{l}{>{\hsize=1.3\hsize}X}%TODO do this in python
\begin{tabularx}{\textwidth}
{| Y@{} | s@{} | Y@{} | Y@{} | Y@{} | Y@{} |}
\multicolumn{5}{c}{\fontsize{25}{25}\selectfont\color{pfgrey}{Warranties Claims - \monthyeardate\today}}\\
\hline
...
\multicolumn{5}{c}{\fontsize{25}{25}\selectfont\color{pfgrey}{Warranties Claims - \monthyeardate\today (cont.)}}\\
\hline
\textbf{Label1} &\textbf{Label2} &\textbf{Label3} &\textbf{Label4} &\textbf{Label5}\\
\hline
...
Color Cell & Color Cell &sdfkjh  & asdfkjh & \\
%\hline
%Color Cell & slfkjsalkdfj kdjflksj dsfj  &sdfkjh  & asdfkjh & \\
\hline
Color Cell & Color Cell &sdfkjh  & asdfkjh & \\
\hline
Color Cell & Color Cell &sdfkjh  & asdfkjh & \\
...
\begin{figure}[H]
	...
	\includegraphics[width=.8\textwidth]{insert.pdf}
\end{figure}
%-----Custom PDF insert-----%
\newpage
\begin{figure}[H]
