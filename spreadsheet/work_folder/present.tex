...
\newcommand\addsection[1]{\markright{#1}\addtocounter{section}{1}\phantomsection\addcontentsline{toc}{section}{{\arabic{section}.\xspace } {#1}}}
\newcommand\addsubsection[1]{\addtocounter{subsection}{1}\phantomsection\addcontentsline{toc}{subsection}{{} {#1}}}
\newcommand\addsubsubsection[1]{\addtocounter{subsubsection}{1}\phantomsection\addcontentsline{toc}{subsubsection}{{} {#1}}}
%-----------------------------------------%
...
\ClearShipoutPicture
\AddToShipoutPictureBG{\pflogoarttwo}
\pagestyle{style2}
